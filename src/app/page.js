                ...
                <div className="grid md:grid-cols-2 gap-6 text-left">
                  <div>
                    ...
                    <ul className="text-gray-600 dark:text-gray-300 space-y-2">
                      <li>
                        • <strong>PIX:</strong> Desconto especial
                      </li>
                      <li>
                        • <strong>Cartão de Crédito:</strong> Através da
                        plataforma Doity
                      </li>
                    </ul>
                  </div>
                  <div>
                    ...
                    <ul className="text-gray-600 dark:text-gray-300 space-y-2">
                      <li>
                        • <strong>Primeiras 50 inscrições:</strong> Brindes
                        exclusivos
                      </li>
                      <li>
          ...
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-600 dark:text-gray-300 mb-12">
                Empresas que patrocinam e apoiam este evento
              </p>
            </div>
            ...
            <div className="flex flex-wrap items-center justify-center gap-8 mb-16 max-w-xl mx-auto">
              ...
              <div
                ...
                onClick={() =>
                  window.open("https://www.bdados.com.br", "_blank")
                }
            ...
            <div className="bg-white dark:bg-dark-700 rounded-lg p-8 shadow-sm max-w-md mx-auto text-center">
            ...
            <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
              <div className="bg-gradient-to-br from-primary-500/10 to-primary-600/10 border border-primary-200/30 rounded-xl p-8">
                ...
                <p className="text-gray-600 dark:text-gray-300 mb-4">
                  ...
                  empreendedorismo ou inovação. Compartilhe experiências, cases
                  de sucesso ou tendências do mercado.
                </p>
                <ul className="text-sm text-gray-500 dark:text-gray-400 space-y-1">
                  ...
                  <li>
                    • <strong>Prazo de submissão: 18/08</strong>
                  </li>
                  <li>
                    • <strong>Inscrição gratuita para palestrantes</strong>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-gradient-to-br from-secondary-500/10 to-secondary-600/10 border border-secondary-200/30 rounded-xl p-8">
                ...
                <p className="text-gray-600 dark:text-gray-300 mb-4">
                  ...
                  participantes possam aprender fazendo. Ideal para tecnologias
                  específicas ou metodologias.
                </p>
                <ul className="text-sm text-gray-500 dark:text-gray-400 space-y-1">
                  <li>• Duração: Até 45 minutos</li>
            ...
            <div className="text-center mt-12">
              <div className="bg-white dark:bg-dark-700 rounded-lg p-8 shadow-sm max-w-2xl mx-auto">
                ...
                <p className="text-gray-600 dark:text-gray-300 mb-6">
                  ...
                  contato conosco para mais informações sobre o processo de
                  seleção.
                  <br />
