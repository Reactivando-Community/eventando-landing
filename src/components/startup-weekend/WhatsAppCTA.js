...
export default function WhatsAppCTA() {
  return (
    <section className="py-20 px-6 bg-techstars-green relative overflow-hidden">
      {/* Background patterns */}
      ...
      <div className="max-w-4xl mx-auto text-center relative z-10">
        <motion.div
          ...
          className="space-y-8"
        >
          <div className="inline-flex items-center px-4 py-2 bg-black/10 rounded-full text-black font-bold text-sm uppercase tracking-wider">
          ...
          <p className="text-xl text-black/80 max-w-2xl mx-auto leading-relaxed font-medium">
          ...
          >
            <a
              ...
              className="inline-flex items-center px-10 py-5 bg-black hover:bg-zinc-800 text-white font-bold text-xl rounded-2xl shadow-2xl transition-all duration-300"
            >
              <svg
