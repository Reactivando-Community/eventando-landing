      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-20">
          ...
          <p className="text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
            ...
            conhecimentos e experiências únicas no techstars_ Startup Weekend <span className="text-[#0EA5E9]">Anápolis</span>
          </p>
        </div>
        ...
        <div className="text-center">
          <div className="bg-primary-800 rounded-2xl p-8 text-white">
            ...
            <p className="text-lg opacity-90 mb-6">
              ...
              no techstars_ Startup Weekend <span className="text-[#0EA5E9]">Anápolis</span>
            </p>
            <a
